...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <h1>Welcome {{ Auth::user()->name }}</h1> <!-- welcome to the user -->
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth                   
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" style="color:#44aabb;">Logout</button> <!-- if the user is logged in, show logout button -->
                        </form>
                    @else <!-- else show register or log in button -->
                            ...
                            @else
                                <ul class="list-unstyled">
                                    @foreach ($comentarios as $comentario)
                                        @if ($comentario->id == Auth::user()->id) <!-- only show comments made by the user that is logged in -->
                                        <li>
                        ...
                        <form action="{{ route('comentarios.store') }}" method="post">               
                            ...
                            <br>                                  
                                ...
                                <div class="form-group">
                                    <textarea name="comentario" id="comentario" cols="60" rows="8" class="form-control"></textarea>
                                </div>
                                <button type="submit" class="btnenviar">Send Comment</button>
                        </form>                                
                    </div>
                </div>
            @endif       
